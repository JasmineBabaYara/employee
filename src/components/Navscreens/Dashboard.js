        ...
        <div>
          <div className="contact">
            ...
            <div className="namediv">
              ...
              <div>
                <p>Keith Morgan</p>
                <p className="nametxt">bins.joanny@murray.info</p>
              </div>
            </div>
          ...
          <div className="contact">
            ...
            <div className="namediv">
              ...
              <div>
                <p>Ophelia Gilbert</p>
                <p className="nametxt">dudly.tromp@yahoo.com</p>
              </div>
            </div>
          ...
          <div className="contact">
            ...
            <div className="namediv">
              ...
              <div>
                <p>Isabel Hudson</p>
                <p className="nametxt">regan.johns@yahoo.com</p>
              </div>
            </div>
          ...
          <div className="contact">
            ...
            <div className="namediv">
              ...
              <div>
                <p>Warren Mullins</p>
                <p className="nametxt">sibse.nonny@yahoo.info</p>
              </div>
            </div>
            <p className="web">Web Designer</p>
            <p className="number">711-487-1057</p>
          ...
          <div className="contact">
            ...
            <div className="namediv">
              ...
              <div>
                <p>Lena Nguyen</p>
                <p className="nametxt">thres_tilman@wilden.biz</p>
              </div>
            </div>
          ...
          <div className="contact">
            ...
            <div className="namediv">
              ...
              <div>
                <p>Alberta Hayes </p>
                <p className="nametxt">saer_walae@yahoo.com</p>
              </div>
            </div>
          ...
          <div className="contact">
            ...
            <div className="namediv">
              ...
              <div>
                <p>Harold Stokes</p>
                <p className="nametxt">zoey.waker@yahoo.com</p>
              </div>
            </div>
